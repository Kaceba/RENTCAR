<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GestisciContratti.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <p>
            ...
            <asp:Button ID="aggiornaGriglia" runat="server" Text="Aggiorna Griglia" OnClick="btnAggiorna_Click" />
        </p>
    </div>
</asp:Content>
