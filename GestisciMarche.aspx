    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.dialogModifica').click(function () {
                ...
                var url = 'ModificaMarche.aspx';
                var dialog = $('<iframe src="' + url + '" frameborder="0"></iframe>').appendTo('body');

                dialog.dialog({
                    modal: true,
                    title: 'Modifica Marche',
                    resizable: true,
                    width: '400px',
                    overlay: { opacity: 0.9, background: 'black' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="griglia" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" DataKeyNames="codiceMarche" OnSelectedIndexChanged="griglia_SelectedIndexChanged">
