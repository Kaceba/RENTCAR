...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.dialogElimina').click(function () {

                var url = 'EliminaSpese.aspx';
                var dialog = $('<iframe src="' + url + '" frameborder="0"></iframe>').appendTo('body');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="griglia" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" DataKeyNames="codiceSpesa" OnSelectedIndexChanged="griglia_SelectedIndexChanged">
    ...
    <p>
        ...
        <asp:Button Class="dialogElimina" ID="btnElimina" runat="server" Text="Elimina" Enabled="False" />
